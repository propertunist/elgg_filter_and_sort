...
#elgg-filter-options{padding:10px 0 4px;margin: 0 auto;display:none;clear:both;}
#elgg-filter-options label {display:inline-block;}
#elgg-sort-filtering{padding: 0px 3px 5px 0px;text-align: right;}
.elgg-filter-option-even{float:right;padding-bottom: 6px;margin-right:11px;}
.elgg-filter-option-odd{float:left;padding-bottom: 6px;margin-right:6px;margin-left:15px;}
#elgg-filter-options-link,#elgg-reset-sort-filters{font-size:87%;float: right;margin-top: -4px;margin-right: 9px;padding-bottom: 5px;}
...
#elgg-reset-sort-filters{float: right;margin: -2px 5px 0 18px;}
#elgg-reset-sort-filters span {margin-left: 5px;top: 4px;}
#filter_options_go_btn {float: right; margin: 0 10px 8px;}
